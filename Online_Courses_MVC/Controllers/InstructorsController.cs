...
namespace Online_Courses_MVC.Controllers
{
    public class InstructorsController : Controller
    {
        ...
        public InstructorsController(Online_Courses_DBContext context)
        {
            _context = context;
        }
        [Authorize]
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email")] Instructor instructor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email")] Instructor instructor)
        {
            if (id != instructor.Id)
            {
                return NotFound();
